...
Soldier-Sense is Soldier Sense is an emergent behaviour simulation in the domain of urban warfare.

- It is cross-platform running on Windows, Linux and MacOS.
- Avoid operating system specific code in favour of cross-platform libraries.
- Use git-bash for cross-platform scripting inside Justfiles.
...
- **Challenge assumptions**: If code has clear technical flaws, point them out directly but politely
