...
// sqr returns the square of x. Hopefully the compiler will inline this and optimize away redundant squarings in hot paths.
...
// In addition when `r` is known at compile time, the caller can precompute `r*r` and avoid a runtime multiplication.
